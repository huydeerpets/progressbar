var renderUnboundRating = function(rating) {
  ...
  var roundvalue = Math.round(rating)*10
    var value = rating*10,
		...
		star = '<div class="lens-rating"><span class="rating-'+roundvalue +'" id="reviewsbar" style="box-shadow:2px 2px 5px 1px #111 inset; width:'+value +'%" max="100"><span class="exact-rating">('+rating+')</span></span></div>';
